...
import com.iuh.kltn.kikistore.Adapter.AdapterDanhGia;
import com.iuh.kltn.kikistore.Adapter.AdapterViewPagerSlider;
import com.iuh.kltn.kikistore.Model.DangNhap_DangKy.ModelDangNhap;
import com.iuh.kltn.kikistore.Model.ObjectClass.ChiTietKhuyenMai;
import com.iuh.kltn.kikistore.Model.ObjectClass.ChiTietSanPham;
import com.iuh.kltn.kikistore.Model.ObjectClass.DanhGia;
import com.iuh.kltn.kikistore.Model.ObjectClass.SanPham;
import com.iuh.kltn.kikistore.Presenter.ChiTietSanPham.FragmentSliderChiTietSanPham;
...
import com.iuh.kltn.kikistore.View.DanhGia.DanhSachDanhGiaActivity;
import com.iuh.kltn.kikistore.View.DanhGia.ThemDanhGiaActivity;
    ...
    public void HienChiTietSanPham(final SanPham sanPham) {
        ...
        if(chiTietKhuyenMai !=null){
            ...
            if(phamtramkm != 0){
                ...
                giatien = giatien-(giatien * phamtramkm/100);
            }
    ...
    public void onClick(View v) {
        ...
        switch (id){
            case R.id.txtVietDanhGia:
                ...
                String tennv1 = modelDangNhap.LayCachedDangNhap_DatHang(this).getTenNV();
                if(!tennv1.equals("")) {
                    //-----------------
